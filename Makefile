...
bm_test: bm_main.o bm_page.o pm.o tx.o lm.o rm.o mm.o
	gcc -o $@ bm_main.o bm_page.o pm.o tx.o lm.o rm.o mm.o \
	$(CFLAGS) $(LDFLAGS)

test.o: test.c $(BT_EXT) $(BM_EXT) $(PM_EXT) $(LM_EXT) $(TX_EXT) $(GLOBAL)
	gcc -c test.c $(CFLAGS) -o $@
test: test.o bt.o bt_page.o bm.o bm_page.o pm.o tx.o lm.o rm.o mm.o
	gcc -o $@ test.o bt.o bt_page.o bm.o bm_page.o pm.o tx.o lm.o \
	rm.o mm.o $(CFLAGS) $(LDFLAGS)

mkfs.o: mkfs.c $(BT_EXT) $(BM_EXT) $(PM_EXT) $(LM_EXT) $(TX_EXT) $(GLOBAL)
	gcc -c mkfs.c $(CFLAGS) -o $@
mkfs: mkfs.o bt.o bt_page.o bm.o bm_page.o pm.o tx.o lm.o rm.o mm.o
